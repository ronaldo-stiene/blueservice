<?php
/**
 * Este arquivo implementa a página de exibição dos produtos pesquisados.
 *
 * Ele contém:
 * - Produtos obtidos durante a busca
 *
 * @package BlueService
...
require_once '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'global.php';
